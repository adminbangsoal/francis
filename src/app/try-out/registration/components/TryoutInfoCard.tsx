  ...
  return (
    <div className="relative mb-3 max-w-xl rounded-2xl bg-[#064E3B33] px-5 py-4 text-white lg:max-w-2xl">
      <Image
        ...
        alt="free"
      />
      <h3 className="text-2xl font-600">Try Out Pro 5</h3>
      ...
      <p className="font-500 text-emerald-100">
        Yuk jangan kelewatan dan segera ikuti Try Out kelima dari BangSoal! Soal
        Tryout diadaptasi dari soal-soal UTBK asli loh!! Yuk daftar{" "}
        <b>gratis</b> sekarang!
      </p>
    </div>
  );
